# -*- coding: utf-8 -*-
"""
Created on Thu Jul  8 20:01:51 2021
...
def pival():
    ...
    i+=length        
root=Tk()
root.title("Dev Bhardwaj's Python Calculator")
display = Entry(root)
...
Button(root,text="pi",command= lambda :pival()).grid(row=2,column=4, sticky=N+S+E+W)
